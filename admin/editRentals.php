...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
	  <div class="card-header py-3">
	    <h6 class="m-0 font-weight-bold text-primary">EDIT Rentals</h6>
	  </div>
	  ...
	  <div class="card-body">
	  	...
	  	<?php
			...
			if (isset($_POST['edit_btn'])) {
				...
				$qeury = "SELECT * FROM rentals WHERE id='$id' ";
	...
	<form action="updateRentals.php" method="post">
	    ...
	    <a href="rentals.php" class="btn btn-primary">CANCEL</a>
	    <button type="submit" name="edit_rentals_btn" class="btn btn-success">UPDATE</button>
	</form>
